...
import PermanentFaq from "@/app/dumpsters/permanent-dumpsters/permanent-faq";
...
export default async function PermanentDumpstersPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <div className="inline-flex px-4 py-2 rounded-full bg-[#FFD700]/10 text-[#FFD700] text-sm font-bold mb-5">
                ...
                Recurring Commercial Waste Solutions

              </div>

              <h1 className="text-3xl lg:text-5xl font-black text-white leading-tight">

                Permanent Dumpster Services

              </h1>

              <p className="mt-5 text-gray-300 max-w-xl">

                Reliable long-term dumpster services for businesses, offices, apartment communities, retail locations and commercial properties.
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl lg:text-5xl font-black text-[#0A1628] mt-5">
              ...
              Compare Permanent Dumpster Options

            </h2>

            <p className="mt-5 text-gray-600 max-w-2xl mx-auto">

              Explore dimensions, capacities and available service options.
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl lg:text-5xl font-black text-[#0A1628]">
              ...
              Our Permanent Dumpster Options
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            {dumpsters.map((dumpster: any) => (
              ...
              >
                ...
                <Link
                  href={`/dumpsters/permanent-dumpsters/${dumpster.slug}`}
                  className="
                                    mt-auto
                                    w-full
                                    py-3
      ...
      <section className="py-20 bg-[#0A1628]">
        ...
        <div className="max-w-5xl mx-auto text-center px-5">
          ...
          <p className="text-gray-300 mt-5">
            ...
            Get matched with the right commercial dumpster solution for your ongoing waste needs.
