// app/dumpsters/rubber-wheeled-dumpsters/page.tsx

import { Header } from "@/components/header";
import { Footer } from "@/components/footer";
import { Button } from "@/components/ui/button";
import RubberFaq from "@/app/dumpsters/rubber-wheeled-dumpsters/rubber-faq";
...
export default async function RubberWheeledPage() {
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                        ...
                        <div>
                            ...
                            <h1 className="text-3xl lg:text-5xl font-black text-white leading-tight">
                                ...
                                Rubber Wheeled Dumpster Rentals

                            </h1>

                            <p className="mt-5 text-gray-300 max-w-xl">

                                Protect driveways and surfaces with premium dumpster rentals designed for residential projects and cleanups.
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="mt-5 text-gray-600 max-w-2xl mx-auto">
                            ...
                            Compare dimensions and included rental periods.
                                    ...
                                    (dumpster: any, index: number) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="p-2 sm:p-4" align="center">
                                                    <div className="leading-5">
                                                        <div>
                                                            <span className="font-bold">Length:</span> {size?.length_ft}'
                                                        </div>

                                                        <div>
                                                            <span className="font-bold">Width:</span> {size?.width_ft}'
                                                        </div>

                                                        <div>
                                                            <span className="font-bold">Height:</span> {size?.height_ft}'
                                                        </div>
                                                    </div>
                                                </td>
                    ...
                    <div className="mt-8 rounded-3xl bg-[#FFF8E1] border border-[#FFD700] p-6 text-sm leading-7">

                        <b>Important Information:</b>

                        <p className="mt-3">

                            Our containers are sized by internal volume. External dimensions can vary depending on manufacturer, location and equipment availability.

                        </p>

                        <p className="mt-2">

                            Dumpster color, appearance and branding shown in photos may differ from the delivered container. BlueSky Disposal coordinates services through local hauling partners and is not the manufacturer.
                    ...
                    <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
                        ...
                        {dumpsters.map((dumpster: any) => (
                            ...
                            >
                                ...
                                {/* CTA */}
                                <Link
                                    href={`/dumpsters/rubber-wheeled-dumpsters/${dumpster.slug}`}
                                    className="
                                    mt-auto
                                    w-full
                                    py-3
            ...
            <section className="py-20 bg-[#0A1628]">
                ...
                <div className="max-w-5xl mx-auto text-center px-5">
                    ...
                    <p className="text-gray-300 mt-5">
                        ...
                        Use our AI recommendation tool and get matched with the right dumpster in seconds.
