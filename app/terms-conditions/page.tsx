...
export const metadata = {
  title: "Terms & Conditions | Blue Sky Disposal",
  description: "Terms and Conditions for Blue Sky Disposal dumpster rental services.",
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none space-y-12 text-[15px] leading-relaxed text-gray-700">
            ...
            <div className="space-y-6">
              ...
              <section>
                <p>
                  <strong>2. Payment dispute.</strong> In the event Customer disputes credit card charge such as overweight fees, dry run fees, as agreed upon, Blue Sky Disposal may, upon 5 days’ written notice to Customer remove its equipment and any materials deposited therein, or may leave the equipment on site, without providing service until payment in full is made. The customer will remain personally liable for all the fees incurred for nonpayment and legal fees will be applicable.
                </p>
              </section>

              <section>
                <p>
                  <strong>3. Cancellations.</strong> If Customer has purchased the dumpster via credit card through Stripe, PayPal, Authorized.net and would like to cancel the order, Blue Sky Disposal reserves the right to charge 10% of your total cost and will refund the difference back onto the customer’s credit card.
                </p>
              </section>

              <section>
                <p>
                  <strong>4. Definition of Equipment.</strong> The term “equipment” as used herein, shall mean all equipment and containers provided by Blue Sky Disposal providing the services as noted on the face of this Agreement. All equipment provided by Blue Sky Disposal, which Customer has not purchased shall remain the property of Blue Sky Disposal and Customer shall have no right, or interest in the equipment and the equipment shall be returned to Blue Sky Disposal in the same condition as received upon termination of this agreement.
                </p>
              </section>

              <section>
                <p>
                  <strong>5. Waste Materials, Services Rendered.</strong> Customer guarantees that the waste materials delivered to Blue Sky Disposal under this Agreement will not contain any hazardous, toxic or radioactive waste or other special waste as those terms are defined under applicable federal, state and or local laws or regulation defined substances (e.g., tires, liquids). Customer shall retain liability to all waste materials. Blue Sky Disposal shall be entitled to return the equipment to Customer’s site for unloading waste material that is rejected at the disposal site or that otherwise violated this paragraph. Customer shall identify, defend and hold Blue Sky Disposal harmless from and against all claims, liabilities, fines and costs of any nature whatsoever, arising out of the breach stated above, including extra hauling and/or disposal fees incurred. Customer shall also not load equipment waste control and waste recycling company for all Customer’s locations within Blue Sky Disposal’s geographical service areas. This agreement’s terms and conditions shall supersede customer –issued agreements and/or purchase orders.
                </p>
              </section>

              <section>
                <p>
                  <strong>6. Placement Areas.</strong> Customer guarantees and represents that any right of way provided by Customer from Customer’s equipment placement location to the most convenient public way, is sufficient to hold the weight of all the Blue Sky Disposal’s equipment and vehicles required to perform the service herein contracted. Blue Sky Disposal shall not be responsible for damage for any private pavement or accompanying subsurface of any route necessary to perform the services contained herein and shall not be responsible for overhead objects such as electrical wire, overhanging rooflines or leaves, trees, ect. Customer agrees that Blue Sky Disposal shall have access to its Equipment at all times. If a container cannot be accessed by driver upon arrival due to, but not limited to, reasons such as overloading or blocked access, a $150.00 per hour demurrage fee shall be applied to Customer’s credit card on file by Blue Sky Disposal. Customer shall defend and hold Blue Sky Disposal harmless from all claims, Damages, suits, penalties, fines, liabilities, and extra costs for any such damage or for extra hauling fees due to inaccessibility of equipment.
                </p>
              </section>

              <section>
                <p>
                  <strong>7. Force Majeure.</strong> Blue Sky Disposal’s failure to perform its obligations under this Agreement, if caused by Force Majeure, shall not constitute breach. “Force Majeure” means any circumstance beyond the reasonable control of Blue Sky Disposal, including but not limited to, any act of God or a public enemy, accident, explosion, fire, storm, earthquake, other natural disaster, strikes, labor, trouble, riot or war, or mechanical or technological malfunctions.
                </p>
              </section>

              <section>
                <p>
                  <strong>8. Changes.</strong> Changes in frequency of collection service, locations, or in the number, capacity and type of Equipment, may be agreed in writing by the parties. Customer’s change of its business shall not terminate this agreement when the Customer’s new location and or new owner is within Blue Sky Disposal’s service area unless otherwise provided in writing by Customer.
                </p>
              </section>

              <section>
                <p>
                  <strong>9. Corporate Authority, Personal Guaranty.</strong> The Customer’s individual signatory to this Agreement hereby agrees that he/she is an authorized agent of Customer, has been directed to enter into this Agreement on behalf of Customer and has full authority to bind Customer to all the terms and conditions contained in this Agreement. If the owner or the officer of the corporation is signing this agreement, the owner or officer individually signing personally guarantees that payment shall be made should the corporation for any reason fail to make necessary payments. Legal action filed against the individual signing and/or the corporation is at the Blue Sky Disposal’s own discretion. Contractor reverses the right to assign this Agreement and/or delegate its obligations hereunder. If Customer sells all parts of its business, this agreement shall be honered by and bind the new owner’s of Customer’s business. Blue Sky Disposal may utilize a subcontractor at any time in performing the services herein.
                </p>
              </section>

              <section>
                <p>
                  <strong>10. Cost Increases.</strong> Because landfill charges, fuel costs and/or other vendor costs are a significant cost of the services provided by Blue Sky Disposal and/or its vendors under the Agreement, Blue Sky Disposal may increase the price due to the increased costs of nature.
                </p>
              </section>
            </div>
            ...
            <div className="space-y-6">
              ...
              <section>
                <p>
                  <strong>8. Changes.</strong> Changes in frequency of collection service, locations, or in the number, capacity and type of Equipment, may be agreed in writing by the parties. Customer’s change of its business shall not terminate this agreement when the Customer’s new location and or new owner is within Blue Sky Disposal’s service area unless otherwise provided in writing by Customer. If Customer and /or new owner relocate outside of Blue Sky Disposal’s service area, then Customer shall be released from this Agreement.
                </p>
              </section>

              <section>
                <p>
                  <strong>9. Corporate Authority, Personal Guaranty.</strong> The Customer’s individual signatory to this Agreement hereby agrees that he/she is an authorized agent of Customer, has been directed to enter into this Agreement on behalf of Customer and has full authority to bind Customer to all the terms and conditions contained in this Agreement. If the owner or the officer of the corporation is signing this agreement, the owner or officer individually signing personally guarantees that payment shall be made should the corporation for any reason fail to make necessary payments. Legal action filed against the individual signing and/or the corporation is at the Blue Sky Disposal’s own discretion. Contractor reverses the right to assign this Agreement and/or delegate its obligations hereunder. If Customer sells all parts of its business, this agreement shall be homered by and bind the new owner’s of Customer’s business. Contractor may utilize a subcontractor at any time in performing the services herein.
                </p>
              </section>
